package com.iwj.netty.standard;

import com.iwj.netty.pojo.PojoEndpointServer;
import com.iwj.netty.util.SslUtil;
...
public class WebsocketServer {
    ...
    public void init() throws InterruptedException, SSLException {
        ...
        if (!StringUtils.isEmpty(config.getKeyStore())) {
            sslCtx = SslUtil.createSslContext(config.getKeyPassword(), config.getKeyStore(), config.getKeyStoreType(), config.getKeyStorePassword(), config.getTrustStore(), config.getTrustStoreType(), config.getTrustStorePassword());
        } else {
            sslCtx = null;
        }
